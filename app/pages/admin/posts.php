    ...
    <div class="col-md-12 mx-auto">
        <form method="post" enctype="multipart/form-data">
            ...
            <?php if (!empty ($row)): ?>
                ...
                <div class="">
                    <textarea id="summernote" row="8" placeholder="Post Content" name="content" type="content"
                        class="form-control"><?= old_value('content', add_root_to_images($row['content'])) ?></textarea>
                    <label for="floatingInput">Posts Content</label>
                </div>
                <?php if (!empty ($errors['content'])): ?>
                    <div class="text-danger">
